...
bool TankEnemy2::Start()
{
	...
	m_tank = FindGO<TankEnemy>("TankEnemy");
	...
	//パス
	m_enemypath2.Init("Assets/path2/tank/enemypath2.tkl");
	m_enemypath4.Init("Assets/path2/tank/enemypath4.tkl");
	//ポイント
...
void TankEnemy2::alertTransition()
{
